...
class Prime3TrackerService:
    ...
    def start(self) -> None:
        ...
        port = int(cast("int | str", self._configuration.get("bind_port", CP3W_SERVER_PORT)))
        ...
        self._bind_host, self._bind_port = cast("tuple[str, int]", self._server.server_address)
