...
TRANSPORT_PHASE_NAMES = {
    ...
    36: "WAIT_SEND",
    37: "SENT_DATAGRAM",
    38: "SEND_SUBMIT_FAILED",
    39: "SEND_ASYNC_FAILED",
    40: "SEND_INVALID_POSITIVE",
    ...
    50: "CP3W_VALIDATE_FRAME",
    51: "CP3W_FRAME_VALID",
    52: "CP3W_FRAME_REJECTED",
    53: "CP3W_SUBMIT_RESPONSE",
    54: "CP3W_WAIT_RESPONSE",
    55: "CP3W_FRAME_LOOP_COMPLETE",
    56: "CP3W_DISPATCH_REQUEST",
    57: "CP3W_HANDLE_PING",
    58: "CP3W_HANDLE_UNSUPPORTED_COMMAND",
    ...
    if config.manifest.relocated_runtime is not None:
        ...
        if runtime_metadata.transport is not None:
            ...
            transport_observation: dict[str, object] = {
                ...
                "cp3w_magic_hex": transport.cp3w_magic_hex,
                "cp3w_protocol_version": transport.cp3w_protocol_version,
                "cp3w_header_size": transport.cp3w_header_size,
                "cp3w_crc_size": transport.cp3w_crc_size,
                "cp3w_crc_initial_value": transport.cp3w_crc_initial_value,
                "cp3w_crc_final_xor_value": transport.cp3w_crc_final_xor_value,
                "cp3w_crc_polynomial": transport.cp3w_crc_polynomial,
                "cp3w_crc_reflected": transport.cp3w_crc_reflected,
                "cp3w_packet_kind_request": transport.cp3w_packet_kind_request,
                "cp3w_packet_kind_response": transport.cp3w_packet_kind_response,
                "cp3w_response_status_error": transport.cp3w_response_status_error,
                "cp3w_command_ping": transport.cp3w_command_ping,
                "cp3w_pong_command": transport.cp3w_pong_command,
                "cp3w_pong_uses_ping_command": transport.cp3w_pong_uses_ping_command,
                "cp3w_command_reserved_mailbox": transport.cp3w_command_reserved_mailbox,
                "cp3w_error_code_unknown_command": transport.cp3w_error_code_unknown_command,
                "cp3w_packet_kind_offset": transport.cp3w_packet_kind_offset,
                "cp3w_command_offset": transport.cp3w_command_offset,
                "cp3w_response_status_offset": transport.cp3w_response_status_offset,
                "cp3w_request_id_offset": transport.cp3w_request_id_offset,
                "cp3w_payload_length_offset": transport.cp3w_payload_length_offset,
                "cp3w_ping_max_payload_length": transport.cp3w_ping_max_payload_length,
                "cp3w_request_payload_ascii": transport.cp3w_request_payload_ascii,
                "cp3w_response_payload_ascii": transport.cp3w_response_payload_ascii,
                "cp3w_unsupported_message_ascii": transport.cp3w_unsupported_message_ascii,
                "cp3w_request_payload_length": transport.cp3w_request_payload_length,
                "cp3w_response_payload_length": transport.cp3w_response_payload_length,
                "prepared_send_length": optional_u32(transport.prepared_send_length_address),
                "cp3w_datagrams_processed": optional_u32(transport.cp3w_datagrams_processed_address),
                "cp3w_frames_valid": optional_u32(transport.cp3w_frames_valid_address),
                "cp3w_frames_invalid": optional_u32(transport.cp3w_frames_invalid_address),
                "cp3w_frames_too_short": optional_u32(transport.cp3w_frames_too_short_address),
                "cp3w_frames_invalid_magic": optional_u32(transport.cp3w_frames_invalid_magic_address),
                "cp3w_frames_invalid_version": optional_u32(transport.cp3w_frames_invalid_version_address),
                "cp3w_frames_unsupported_type": optional_u32(transport.cp3w_frames_unsupported_type_address),
                "cp3w_frames_nonzero_flags": optional_u32(transport.cp3w_frames_nonzero_flags_address),
                "cp3w_frames_length_mismatch": optional_u32(transport.cp3w_frames_length_mismatch_address),
                ...
                "cp3w_unsupported_commands_received": optional_u32(
                    transport.cp3w_unsupported_commands_received_address
                ),
                "cp3w_unsupported_responses_submitted": optional_u32(
                    transport.cp3w_unsupported_responses_submitted_address
                ),
                ...
                "cp3w_last_dispatch_result": optional_u32(transport.cp3w_last_dispatch_result_address),
