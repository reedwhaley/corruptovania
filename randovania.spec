...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "randovania.game_connection.builder.prime3_tcp_tracker_connector_builder",
        "randovania.game_connection.prime3_tcp_tracker",
        "randovania.games.prime3.exporter.cp3w_endpoint",
        "randovania.games.prime3.exporter.runtime_payload",
